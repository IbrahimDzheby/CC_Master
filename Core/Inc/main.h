...
#define MISO5_Pin GPIO_PIN_7
#define MISO5_GPIO_Port GPIOA
#define MISO4_Pin GPIO_PIN_5
#define MISO4_GPIO_Port GPIOC
#define LED1_Pin GPIO_PIN_1
#define LED1_GPIO_Port GPIOB
#define LED2_Pin GPIO_PIN_2
#define LED2_GPIO_Port GPIOB
#define MISO1_Pin GPIO_PIN_15
#define MISO1_GPIO_Port GPIOB
#define MISO2_Pin GPIO_PIN_7
#define MISO2_GPIO_Port GPIOC
#define MISO3_Pin GPIO_PIN_9
